...
#register_page(__name__, path="/maptrees13")
...
layout= html.Div(
    ...
    dbc.Row([
        ...
        dbc.Row([
            ...
            html.Div([
                    ...
                    options=[
                        {"label": "comuna1", "value": "comuna1"},
                        {"label": "comuna2", "value": "comuna2"},
                        {"label": "comuna3", "value": "comuna3"},
                        {"label": "comuna4", "value": "comuna4"},
                    ],
                    value=['comuna1', 'comuna2', 'comuna3', 'comuna4'],
                    multi = False
                )
                ])
    ...
    dbc.Row([
        ...
        ,
            ...
            ], center=(4.430081,-75.2112492), zoom=13, style={'height': '600px','with':'1000px'})  
                ],id="row_map3")   
            ])
...
@callback(
        [Output("row_map3", 'children')], 
        [State("id_selector_comuna", "value"),
         Input("id_filtrar", "n_clicks"),       
        ],prevent_initial_call=True
    )

def update_map(selector_comuna,nclicks):
        df_filtrado = map_trees.df[map_trees.df['comuna'].isin(selector_comuna)]
        map_trees.df = df_filtrado
        nuevo_mapa = map_trees.display()
